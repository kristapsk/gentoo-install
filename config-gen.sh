...
copy_from_make_conf_optional PORTAGE_ELOG_MAILURI "$outfile"
copy_from_make_conf_optional ACCEPT_LICENSE "$outfile"
copy_from_make_conf_optional EMERGE_DEFAULT_OPTS "$outfile"
